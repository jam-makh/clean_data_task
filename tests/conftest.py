...
from cleaning_task.utils.io import read_workbook

SOURCE = Path(__file__).resolve().parents[1] / "data/raw/synthetic_dirty_transactions_v4.xlsx"
    ...
    return pd.DataFrame(
        {
            "TXN_ID": [1, 2, 3],
            "ACCOUNT_ID": [10, 10, 11],
            "TXN_DATE_TIME": ["2022-03-10 00:51:36", "09/07/2022 17:49", "04-22-2022 22:52"],
            "SETTLE_DATE": ["2022-03-13", "0000-00-00", "23-Apr-22"],
            "TXN_AMOUNT": ["-104.39", "(808.41)", "5.727.580,00"],
            "TXN_CCY": ["USD", "USD", "LBP"],
            "MERCHANT_NAME": ["SQ *TAKEALOT", "COURSERA.COM *W2PA", "DUBAI MN /ufw"],
            ...
            "PROCESSING_TYPE": ["Purchase", "Purchase Return/Refund", "ATM Cash Withdrawal"],
